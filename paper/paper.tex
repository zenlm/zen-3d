...
\title{Zen 3D: 3D Asset Generation}
...
\begin{itemize}
    \item Point cloud, voxel, mesh output
    \item Pose and bounding box control
    \item Multi-view consistent generation
    \item Fast 3D synthesis
\end{itemize}
...
\midrule
Type & 3D Generation \\
Control & Pose, bbox, sketch \\
Output & Point cloud, voxel, mesh \\
Speed & <1 min per asset
\bottomrule
\end{tabular}
